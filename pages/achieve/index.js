...
const inf = [
...

  {
    ...
    text: `В грудні 2021 року відбувся мій авторський майстерклас "Фігурна стрижка кіпарису". Учні вчились тримати інструменти, надавати форму і майстерно працювати з рослинами`,
    component: Picture,
  },
];
